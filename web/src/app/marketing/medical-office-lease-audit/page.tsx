    ...
    <main className="max-w-4xl mx-auto px-6 py-16 space-y-16">
      ...
      <section className="space-y-6">
        ...
        <p className="text-lg text-gray-600">
          Medical office leases carry unique cost exposure. Shared systems,
          specialized infrastructure, and compliance-driven expenses create
          recurring CAM and NNN volatility that most practices never review.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700">
          Outpatient buildings operate differently than retail or standard
          office. Imaging loads, generator redundancy, infection-control HVAC,
          parking structures, and extended-hour staffing materially increase
          operating expenses. Without clear caps and exclusions, tenants absorb
          unpredictable pass-through risk.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700">
          ...
          frequently outpace general office. Add admin fees layered on CAM and
      ...
      <section>
        ...
        <p className="text-gray-700">
          ...
          $15,000–$85,000 in annual exposure depending on lease structure and
          building age.
        </p>
      </section>
      ...
      <section className="text-center pt-10">
        <Link
          href="/app"
          className="inline-block bg-black text-white px-8 py-4 rounded-lg text-lg font-medium"
        >
    ...
    <main className="max-w-4xl mx-auto px-6 py-16 space-y-16">
      ...
      <section>
        ...
        <p className="mt-4 text-gray-600">
          Learn more about <Link href="/marketing/medical-office-cam-reconciliation" className="underline text-blue-600">medical office CAM reconciliations</Link>.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-4 text-gray-600">
          See a breakdown of <Link href="/marketing/medical-office-nnn-expenses" className="underline text-blue-600">medical office NNN expenses</Link>.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-4 text-gray-600">
          Explore common <Link href="/marketing/medical-practice-lease-overcharges" className="underline text-blue-600">medical lease overcharges</Link>.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-4 text-gray-600">
          Download the <Link href="/marketing/medical-office-lease-audit-checklist" className="underline text-blue-600">medical lease audit checklist</Link>.
        </p>
      </section>
